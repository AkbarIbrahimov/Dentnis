...
@section('content')
    <div class="container">
        ...
        <form action="{{route('admin.DoctorImageEdit',['id'=>$doctorImage->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            @enderror
            <button type="submit" onclick="this.disabled=true;this.form.submit();">Edit DoctorImage</button>
        </form>
    </div>
