            ...
            @foreach($teams as $team)
                ...
                @foreach($team->translations->where('language_id',1) as $translation)
                    <tr class="language-{{$translation->language_id}}">
                        <td style="text-align: center"><a href="{{route('admin.showTeamEdit',['id'=>$team->id])}}"><i class="fa-duotone fa-pen-nib"></i></a></td>
                        <td>{{$team->id}}</td>
                        ...
                        <td style="text-align: center"><a href="{{route('admin.teamDelete',['id'=>$team->id])}}"><i class="fa-duotone fa-trash"></i></a></td>
                    </tr>
                @endforeach
            @endforeach
            </tbody>
