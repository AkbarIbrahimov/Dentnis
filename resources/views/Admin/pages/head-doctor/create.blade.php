...
@section('content')
    <div class="container">
        <h2>Create HeadDoctor</h2>
        <form action="{{route('admin.HeadDoctorCreate')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="btn">
                                ...
                                <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}" id="tab-{{$lang}}" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" placeholder="Description" name="{{$lang}}[description]"
                                                  class="form-control summernote" id="summernote">{{old($lang.'text', isset($model) ? $model->translateOrDefault($lang)->descriprtion : '')}}</textarea>
