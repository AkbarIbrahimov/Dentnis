...
@section('content')
    <div class="container">
        ...
        <form action="{{route('admin.iconCreate')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <button type="submit" onclick="this.disabled=true;this.form.submit();">Create Icon</button>
        </form>
    </div>
