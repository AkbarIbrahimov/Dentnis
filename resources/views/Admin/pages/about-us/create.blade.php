...
@section('content')
    <div class="container">
        ...
        <form action="{{route('admin.aboutUsCreate')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="btn">
            ...
            <button type="submit" onclick="this.disabled=true;this.form.submit();">Create AboutUs</button>
        </form>
    </div>
