...
@section('content')
    <div class="container">
        <h2>Create AboutMenu</h2>
        <form action="{{route('admin.aboutMenuCreate')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="btn">
            ...
            <span class="text-danger">{{$message}}</span>
            @enderror
            <button type="submit" onclick="this.disabled=true;this.form.submit();">Create</button>
        </form>
    </div>
